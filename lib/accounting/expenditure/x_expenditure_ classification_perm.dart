...
class ExpenditureClassification {
  ...
  static const String column7CreateTransactionPermission = 'exp_class_createTransactionPermission';
  static const String column8ReadAllTransactionPermission = 'exp_class_readAllTransactionPermission';
  static const String column9ReadOwnTransactionPermission = 'exp_class_readOwnTransactionPermission';
  static const String column10EditAllTransactionPermission = 'exp_class_editAllTransactionPermission';
  static const String column11EditOwnTransactionPermission = 'exp_class_editOwnTransactionPermission';
  static const String column12DeleteAllTransactionPermission = 'exp_class_deleteAllTransactionPermission';
  static const String column13DeleteOwnTransactionPermission = 'exp_class_deleteOwnTransactionPermission';
    ...
    try {
      account = ExpenditureClassification(
        ...
        createTransactionPermission:
            expClassMap[ExpenditureClassification.column7CreateTransactionPermission] as String?,
        readAllTransactionPermission:
            expClassMap[ExpenditureClassification.column8ReadAllTransactionPermission] as String?,
        readOwnTransactionPermission:
            expClassMap[ExpenditureClassification.column9ReadOwnTransactionPermission] as String?,
        editAllTransactionPermission:
            expClassMap[ExpenditureClassification.column10EditAllTransactionPermission] as String?,
        editOwnTransactionPermission:
            expClassMap[ExpenditureClassification.column11EditOwnTransactionPermission] as String?,
        deleteAllTransactionPermission:
            expClassMap[ExpenditureClassification.column12DeleteAllTransactionPermission] as String?,
        deleteOwnTransactionPermission:
            expClassMap[ExpenditureClassification.column13DeleteOwnTransactionPermission] as String?,
      );
